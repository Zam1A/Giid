...
/// Homepage
class Common2 extends StatefulWidget {
  final String levelValue;

  const Common2({Key? key, required this.levelValue}) : super(key: key);

  @override
  _Common2State createState() => _Common2State();
}

class _Common2State extends State<Common2> {
